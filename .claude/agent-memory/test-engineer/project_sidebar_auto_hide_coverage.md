...
**How to apply:** When any sidebar-auto-hide change is requested, a new unit spec must be created at `ds-studio/test/unit/sidebar-auto-hide.spec.js` using Vitest + happy-dom. See [[project_test_framework]] for setup patterns.
