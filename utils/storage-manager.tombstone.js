 ...
 * 負責 prompt preset 的刪除墓碑（tombstone）管理。
 */
(function (root) {
    'use strict';
    ...
    const bundle = {
        ...
        /**
         * 記錄刪除 tombstone 並寫入 local + sync。同時順手清理過期記錄。
        ...
        /**
         * 清除指定 id 清單的 tombstone 記錄，並寫回 local + sync。
         * 寫入 { ts: now, deleted: false } 的「已清除」墓碑，確保跨裝置合併時
         * 較新的「已清除」意圖能蓋過陳舊一側仍持有的舊「已刪除」記錄。
    ...
    root.__DS_StorageManager_tombstone = bundle;
