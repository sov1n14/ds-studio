/* ===== DS studio i18n — Locale Data =====
 * Pure translation dictionaries (zh_TW, en). No logic — see utils/i18n.js
 * for the engine that consumes this data via the __DS_I18N_Locales bridge.
 */
(function (root) {
  'use strict';
