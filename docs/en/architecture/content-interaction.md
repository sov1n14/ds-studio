# User Interaction Module Architecture

> 📂 [DS studio Documentation](../) › [Architecture](../../ARCHITECTURE.md) (Chinese) › [Content Script Modules](CONTENT_SCRIPTS.md) › User Interaction
>
> **Related Specifications**: [Feature Specifications](../../spec/04-features.md) (Chinese)

## Quote Reply Module

`content/quote-reply.js` implements a `QuoteReply` singleton that adds a floating "Quote Reply" button triggered by text selection in the AI response area.
