...
// 將 Modal 掛載至全域，供 popup.js 存取（classic script 環境）
// 使用 Object.assign 合併，避免與 popup.toast.js 的載入順序互相覆蓋彼此的鍵值
if (typeof window !== 'undefined') {
    window.__DS_PopupModal = Object.assign(window.__DS_PopupModal || {}, { Modal });
}
