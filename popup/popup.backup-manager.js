 ...
 * Modal / Toast / StorageManager 皆為頁面全域（classic script 共享同一作用域）。
...
function bindExportJson(exportJsonBtn) {
    ...
    exportJsonBtn.addEventListener('click', async () => {
        try {
            ...
            Toast.show(dsI18n.t('settingsExportedToast'));
        } catch (err) {
            Toast.show(dsI18n.t('exportFailedToast'));
        }
    });
}
...
function bindImportJson(importJsonBtn, importJsonInput) {
    ...
    importJsonInput.addEventListener('change', async (e) => {
        ...
        try {
            ...
            Toast.show(dsI18n.t('settingsRestoredToast'));
...
function bindExportRestored(exportRestoredBtn) {
    ...
    exportRestoredBtn.addEventListener('click', async () => {
        try {
            ...
            Toast.show(dsI18n.t('restoredBackupExportedToast'));
        } catch (err) {
            Toast.show(dsI18n.t('exportFailedToast'));
        }
    });
...
function bindImportRestored(importRestoredBtn, importRestoredInput) {
    ...
    importRestoredInput.addEventListener('change', async (e) => {
        ...
        try {
            ...
            Toast.show(dsI18n.t('restoredBackupImportedToast'));
...
function bindClearRestored(clearRestoredBtn) {
    ...
    clearRestoredBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            Toast.show(dsI18n.t('restoredRecordsClearedToast'));
        } catch (err) {
            Toast.show(dsI18n.t('clearFailedToast'));
        }
    });
}
